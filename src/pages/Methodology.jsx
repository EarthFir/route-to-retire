...
// ─── Methodology Page ─────────────────────────────────────────────────────────
// Plain-English explanation of how the calculator works. Kept deliberately
// concise; the live "Assumptions" panel carries the exact numbers in use.

export default function Methodology() {
  return (
    <ContentPage
      title="How this calculator works"
      intro="A plain-English summary of the model behind Route to Retire. The exact figures currently in use are shown in the Assumptions panel on the calculator."
    >
      ...
      <Section title="Why results should be treated as illustrative only">
        <p>
          ...
          financial advice, tax advice or a personal recommendation. The results are based
          on simplified assumptions and user-entered data, and small changes to those
          inputs can move the figures significantly.
        </p>
      </Section>
    </ContentPage>
  );
